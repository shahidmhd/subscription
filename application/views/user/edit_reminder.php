...
<div class="row clearfix">
    <div class="col-md-12 col-sm-12">
        <div class="form-group">
           <form class="form-auth-small" action="" name="edit_reminder" id="edit_reminder" method="POST" enctype="multipart/form-data">
            <div class="row clearfix">               
				...
				<div class="col-md-12 col-sm-12">
                     <div class="form-group">
                        <label>Reminder Date<sup>*</sup></label>
                            <input type="text" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-date-autoclose="true" name="reminder_date" class="form-control" value="<?=get_date($reminder['reminder_date'])?>" onkeydown="return false;">
                    </div>
                </div>
				...
				<div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control show-tick" name="color">
											...
											<option value="orange" <?=($reminder['color'] == 'orange')?'selected':''?>>Orange</option> 
                                        </select>
                                    </div>
                                </div>
          ...
          submitHandler: function(form, e) {
			   ...
			   form_data.append('reminder_id', reminder_id);
                 setTimeout(function(){      
                        $.ajax({
                         type: 'POST',
                         url: base_url + 'user/edit_reminder_process',
                         cache: false,
                         async: false,
                         data: form_data,
                         contentType: false,
