                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-custom table-striped m-b-0 c_list" id="inout_list">
...
$(document).ready(function() {  
        var table = $('#inout_list').DataTable({
            "ajax": { type: 'POST', url: base_url+"user/view_inout_ajax"},
