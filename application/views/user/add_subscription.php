                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control number" name="duration">
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control number" name="max_workers">
                            </div>
                        </div>
        ...
        $("#company_add").validate({
            ...
            submitHandler: function(form, e) {
                ...
                setTimeout(function() {
                    $.ajax({
                        type: 'POST',
                        url: base_url + 'user/add_subscription_process',
                        cache: false,
                        async: false,
                        data: form_data,
                        contentType: false,
